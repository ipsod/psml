...
def rectangle(
    ...
    The rounding specifies the diameter of the rounding
...
def circle(
    ...
    The size of the circle is specified by its diameter.
    ...
    return shape(
        "circle( d=%f, $fn=%d );" % ( diameter, facets ) )

def cylinder(
    diameter: _float_or_vector,
    ...
    :param diameter: the diameter of the cylinder,
       or a vector that specifies the diameter and the height
    :param height: the height of the cylinder
    :param facets: number of circle facets

    The size of the cylinder is specified by its the diameter
    ...
    sizes = vector( diameter, height )

    # see remark in circle
    if facets == None: facets = number_of_circle_facets

    return shape(
       "cylinder( d=%f, h=%f, $fn=%d );"
           % ( sizes.x, sizes.y, facets ) )

def cone(
   diameter1: _float_or_vector,
   ...
   facets: _float_or_none = None
    ...
    :param diameter1: the diameter of the cone at its bottom,
       or a vector that specifies the two diameteres and the height
    :param diameter2: the diameter of the cone at its top
    :param height: the height of the cone
    :param facets: number of circle facets

    The size of the cone is specified by its the diameter
    at its base, its diameter at its top, and its height.
    ...
    sizes = vector( diameter1, diameter2, height )

    # see remark in circle
    if facets == None: facets = number_of_circle_facets

    return shape(
        "cylinder( d1=%f, d2=%f, h=%f, $fn=%d );"
...
def sphere(
    ...
    The size of the sphere is specified by its diameter.
